...
This is a template example for lab journaling. Students in Jon Gorham's RStudio Data Visualization course will use this template to learn R, and other things. Students can replace this text with more fun things. People not in my lab can use this too.
